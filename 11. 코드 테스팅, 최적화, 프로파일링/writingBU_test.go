...
func benchmarkCraete(b *testing.B, buffer, filesize int) {
	var err error
	for i := 0; i < b.N; i++ {
...
func Benchmark1Create(b *testing.B) {
	benchmarkCraete(b, 1, 1000000)
}
func Benchmark2Create(b *testing.B) {
	benchmarkCraete(b, 2, 1000000)
}

func Benchmark4Create(b *testing.B) {
	benchmarkCraete(b, 4, 1000000)
}
func Benchmark10Create(b *testing.B) {
	benchmarkCraete(b, 10, 1000000)
}
func Benchmark1000Create(b *testing.B) {
	benchmarkCraete(b, 1000, 1000000)
}
